          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Produk</h5>
                ...
                <form action="{{ route('produk.store') }}" method="post">
                    @csrf
                    <fieldset disabled>
                        <div class="mb-3"><label for="kodeproduklabel">Kode Produk</label>
                        <input class="form-control form-control-solid" id="kode_produk_tampil" name="kode_produk_tampil" type="text" placeholder="Contoh: PR-001" value="{{$kode_produk}}" readonly></div>
                    </fieldset>
                    ...
                    <input class="form-control form-control-solid" id="nama_produk" name="nama_produk" type="text" placeholder="Contoh: Susu" value="{{old('nama_produk')}}">
                    </div>
        
                    <div class="mb-0"><label for="merkproduklabel">Merk Produk</label>
                        <textarea class="form-control form-control-solid" id="merk_produk" name="merk_produk" rows="3" placeholder="Cth: Chimory">{{old('merk_produk')}}</textarea>
                    </div>
                    <br>
                    ...
                    <input type="number" textarea class="form-control form-control-solid" id="harga_produk" name="harga_produk" placeholder="Masukkan harga produk" step="0.01" value="{{ old('harga_produk') }}">
                    </div>
                    <br>
</div>
<br>
